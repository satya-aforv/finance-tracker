...
const InvestmentPaymentForm: React.FC<PaymentFormProps> = ({
  investmentId,
  investment,
  paymentSchedule,
  onSubmit,
  ...
  }, [watchInvestment, investment, setValue]);
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <input
              ...
              value={`Month ${paymentSchedule.month} - ${formatCurrency(
      ...
      {paymentSchedule && (
        <div className="bg-blue-50 p-4 rounded-lg">
          <h4 className="text-md font-medium text-blue-900 mb-3">
            Schedule Details - Month {paymentSchedule.month}
          </h4>
...
export default InvestmentPaymentForm;
