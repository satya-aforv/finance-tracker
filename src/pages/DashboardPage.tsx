...
const DashboardPage: React.FC = () => {
    ...
    const fetchDashboardData = async () => {
      try {
        ...
        if (isManager) {
          ...
          const [overviewResponse, trendingResponse, quickActionsResponse] =
          ...
          if (overviewResponse.status === "fulfilled") {
            ...
            setIsFreshUser(
              overviewResponse.value.data.stats.totalInvestments === 0
            );
          } else {
  ...
  const getActivityIcon = (type: string) => {
    ...
    return (
      icons[type as keyof typeof icons] || <Activity className="h-4 w-4" />
    );
  };
    ...
    <div className="space-y-6">
      ...
      >
        <StatCard
          ...
          color="blue"
          change={
            trendingMetrics?.investments?.percentage
              ? `${trendingMetrics.investments.percentage > 0 ? "+" : ""}${
                  trendingMetrics.investments.percentage
                }% from last month`
              : undefined
          }
        ...
        <StatCard
          ...
          color="green"
          change={`${
            dashboardData.stats.activeInvestments || 0
          } currently active`}
          changeType="neutral"
        />
        <StatCard
          ...
          change={
            trendingMetrics?.revenue?.percentage
              ? `${trendingMetrics.revenue.percentage > 0 ? "+" : ""}${
                  trendingMetrics.revenue.percentage
                }% from last month`
              : undefined
          }
        ...
        <StatCard
          ...
          change={`${formatCurrency(
            dashboardData.stats.remainingValue || 0
          )} remaining`}
          changeType="neutral"
        />
      </motion.div>
      ...
      {isFreshUser && isManager && (
        ...
        >
          ...
          <p className="text-blue-700 mb-4">
            Welcome to your finance management system! Here are the next steps
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <EmptyStateCard
              ...
              actionUrl="/investors?create=new"
            />
            <EmptyStateCard
              ...
              actionUrl="/investments?create=new"
            />
            <EmptyStateCard
              ...
              <div className="divide-y divide-gray-200 max-h-80 overflow-y-auto">
                {dashboardData.recentActivity.slice(0, 8).map((activity) => (
                  <div key={activity.id} className="p-4 hover:bg-gray-50">
                    <div className="flex items-start space-x-3">
                      <div
                        className={`flex-shrink-0 p-1 rounded-full ${getActivityColor(
                          activity.status
                        )}`}
                      >
                ...
                >
                  <div className="flex items-center space-x-3">
                    <div className={`p-2 rounded-lg bg-${shortcut.color}-100`}>
                      <TrendingUp
                        className={`h-5 w-5 text-${shortcut.color}-600`}
                      />
                    </div>
                    <div>
                      <p className="text-sm font-medium text-gray-900">
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-center">
                ...
                <span className="font-semibold">
                  {dashboardData.investorStats.totalInvestors}
                </span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-gray-600">Active Investors</span>
                <span className="font-semibold text-green-600">
                  {dashboardData.investorStats.activeInvestors}
                </span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-gray-600">New This Month</span>
                <span className="font-semibold text-blue-600">
                  {dashboardData.investorStats.newThisMonth}
                </span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-gray-600">With User Accounts</span>
                <span className="font-semibold text-purple-600">
                  {dashboardData.investorStats.withUserAccounts}
                </span>
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="font-semibold text-green-600">
                  {dashboardData.paymentStats.completedPayments}
                </span>
              </div>
              <div className="flex justify-between items-center">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="font-semibold text-blue-600">
                  {dashboardData.paymentStats.thisMonthPayments}
                </span>
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-center">
                ...
                <span className="font-semibold">
                  {dashboardData.planStats.totalPlans}
                </span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-gray-600">Active Plans</span>
                <span className="font-semibold text-green-600">
                  {dashboardData.planStats.activePlans}
                </span>
              </div>
              {dashboardData.planStats.mostPopularPlan && (
                <div className="pt-2 border-t border-gray-200">
                  ...
                  <div className="text-xs text-gray-500">
                    {dashboardData.planStats.mostPopularPlan.investmentCount}{" "}
                    investments
                  </div>
                </div>
              )}
