        ...
        <div className="border-b border-gray-200">
          <nav className="-mb-px flex space-x-8 px-6">
            {[
              ...
              if (
                ["investor", "financor", "admin"].includes(user?.role) &&
                ["investments"].includes(tab.id)
              ) {
                return null;
              }
              return (
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                          ...
                          <input
                            type="number"
                            {...register(
                              "investment.customPlan.maxInvestment",
                              {
                            ...
                            <div className="md:col-span-2">
                              ...
                              <div className="space-y-3">
                                ...
                                <label className="flex items-center">
                                  ...
                                  />
                                  <span className="text-sm">
                                    Flexible Withdrawal – Early withdrawal
                                    allowed
                                  </span>
                                </label>
                              </div>
                              ...
                              <>
                                <div>
                                  ...
                                  <p className="mt-1 text-xs text-gray-500">
                                    % of tenure after which withdrawal is
                                    allowed
                                  </p>
                                </div>
                                <div>
                      ...
                      <div className="bg-gray-50 p-4 rounded-lg mt-4">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                          ...
                          <div>
                            ...
                            <div className="font-medium">
                              {watch("investment.customPlan.tenure") || 0}{" "}
                              months
                            </div>
                          </div>
                          <div>
